...
namespace Application.Features.Color.Handlers
{
    ...
    public class DeleteColorHandler : IRequestHandler<DeleteColorRequest, BaseResponse<ColorResponseDTO>>
    {
        ...
        public async Task<BaseResponse<ColorResponseDTO>> Handle(DeleteColorRequest request, CancellationToken cancellationToken)
        {
