...
namespace Persistence.Repositories
{
	public class UnitOfWork : IUnitOfWork
	{
		...
		public UnitOfWork(StyleHubDBContext context, IProductRepository productRepository, IColorRepository colorRepository, ISizeRepository sizeRepository, IBrandRepository brandRepository, IMaterialRepository materialRepository, IProductColorRepository productColorRepository, IProductSizeRepository productSizeRepository, IProductMaterialRepository productMaterialRepository, IProductImageRepository productImageRepository, ILocationRepository locationRepository)
		{
			_context = context;
