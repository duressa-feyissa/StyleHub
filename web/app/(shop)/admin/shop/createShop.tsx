...
import { shopCreateformSchema } from "@/lib/formSchema";
import { addProduct, createShop } from "@/server/actions/add-product";
...
export default function CreateShop() {
  ...
  const form = useForm<z.infer<typeof shopCreateformSchema>>({
    ...
    defaultValues: {
      ...
      email: "",
      socialMedias: [],
      establishedAt: "2024-04-05T10:31:13",
      profileImage: "",
      coverImage: "",
    },
  });

  const { execute, status } = useAction(createShop, {
    onSuccess(data) {
  ...
  function onSubmit(values: z.infer<typeof shopCreateformSchema>) {
    execute(values);
    // form.reset();
  }
          ...
          <div className="grid auto-rows-max items-start gap-4 lg:col-span-2 lg:gap-8">
            <Card x-chunk="dashboard-07-chunk-0">
              <CardHeader>
                ...
                <CardDescription>
                  Describe your shop in detail to attract customers and improve
                  SEO results
                </CardDescription>
              </CardHeader>
              <CardContent>
